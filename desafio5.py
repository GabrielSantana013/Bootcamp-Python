...
#TODO Salvar os logs em um log.txt
#Sugestão: f"[{data_hora}]: Função {func.__name__} Executada com argumentos {args} e {kwargs}. Retornou {result}\n"
    ...
    def envelope(*args, **kwargs):
        ...
        try:
            with open("log.txt", "a", encoding="utf-8") as file:
                file.write(f"[{data_hora}]: Função {func.__name__} Executada com argumentos {args} e {kwargs}. Retornou {resultado}\n")
        except IOError:
